...
-- password test1234
INSERT INTO app_user (id, password, username, email)
VALUES (1, '$2a$10$5AWyzymSnNypg9BkMOyKE.zA05GtRKHCoWimh.q2w.KAO5koBYPM6', 'admin.admin', 'oopchoi4@gmail.com');
-- password test1234
INSERT INTO app_user (id, password, username, email)
VALUES (2, '$2a$10$5AWyzymSnNypg9BkMOyKE.zA05GtRKHCoWimh.q2w.KAO5koBYPM6', 'john.doe', 'oopchoi@gmail.com');
...
VALUES (1, 'John Doe', '4429  Jessie Street', '43215', 'Columbus', '9j92thgzfwp@fakemailgenerator.net', '520-891-3434',
        1, '2022-01-01', '{"option1":"value1"}', '["onething","anotherthing"]');

INSERT INTO address (id, name, street, zip, city, email, tel, enabled, lastModified, options, things)
VALUES (2, 'Agent Smith', '1730  Polk Street', '85705', 'Tucson', 'd3hf1lbm0z@powerencry.com', '270-466-4222', 1,
        '2022-01-01', '{"option1":"value1"}', '["onething","anotherthing"]');
